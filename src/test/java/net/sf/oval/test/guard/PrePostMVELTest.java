...
public class PrePostMVELTest {
   ...
   public static class TestTransaction {
      ...
      @Post(expr = "_this.valuePost != null", lang = "mvel", message = "POST")
      ...
      @Pre(expr = "_this.valuePre != null", lang = "mvel", message = "PRE")
      ...
      public void increase(@Assert(expr = "_value!=null", lang = "mvel", message = "ASSERT") final BigDecimal value2add) {
         if (buggyMode) {
