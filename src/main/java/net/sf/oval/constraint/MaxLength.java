...
@Constraint(checkWith = MaxLengthCheck.class)
public @interface MaxLength {
    ...
    */
   String errorCode() default "net.sf.oval.constraint.MaxLength";
    ...
    */
   String message() default "net.sf.oval.constraint.MaxLength.violated";
