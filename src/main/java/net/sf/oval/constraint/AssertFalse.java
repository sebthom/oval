...
public @interface AssertFalse {
    ...
    */
   String errorCode() default "net.sf.oval.constraint.AssertFalse";
    ...
    */
   String message() default "net.sf.oval.constraint.AssertFalse.violated";
