...
public class ListOrderedSet<E> implements Cloneable, Set<E>, List<E>
{
	...
	{
		list = CollectionFactory.INSTANCE.createList(16);
	}
	...
	{
		list = CollectionFactory.INSTANCE.createList(initialCapacity);
	}
	...
	{
		final List<E> tmp = CollectionFactory.INSTANCE.createList(c.size());
		for (final E o : c)
		{
			if (!list.contains(o))
			{
