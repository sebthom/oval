...
import net.sf.oval.checks.AssertFalseCheck;
import net.sf.oval.checks.AssertFieldConstraintsCheck;
import net.sf.oval.checks.AssertTrueCheck;
import net.sf.oval.checks.AssertValidCheck;
import net.sf.oval.checks.ContainsCheck;
import net.sf.oval.checks.FutureCheck;
import net.sf.oval.checks.InstanceOfCheck;
import net.sf.oval.checks.LengthCheck;
import net.sf.oval.checks.MaxCheck;
import net.sf.oval.checks.MaxLengthCheck;
import net.sf.oval.checks.MaxSizeCheck;
import net.sf.oval.checks.MinCheck;
import net.sf.oval.checks.MinLengthCheck;
import net.sf.oval.checks.MinSizeCheck;
import net.sf.oval.checks.NoSelfReferenceCheck;
import net.sf.oval.checks.NotEmptyCheck;
import net.sf.oval.checks.NotNegativeCheck;
import net.sf.oval.checks.NotNullCheck;
import net.sf.oval.checks.PastCheck;
import net.sf.oval.checks.RangeCheck;
import net.sf.oval.checks.RegExCheck;
import net.sf.oval.checks.SizeCheck;
...
public class XMLConfigurer implements Configurer
{
	...
	protected final void configureXStream()
	{
		...
		xStream.alias("contains", ContainsCheck.class);
